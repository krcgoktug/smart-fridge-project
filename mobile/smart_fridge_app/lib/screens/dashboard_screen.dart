...
class _DashboardScreenState extends State<DashboardScreen> {
                ...
                builder: (BuildContext context,
                  ...
                  return LayoutBuilder(
                    builder: (BuildContext context, BoxConstraints c) {
                      if (c.maxWidth >= 720) {
                        return _desktopBody(c, sensors, products, alerts);
                      }
                      return _phoneBody(sensors, products, alerts);
                    },
                  );
                },
              );
  ...
  Widget _phoneBody(
      SensorData sensors, List<Product> products, List<Alert> alerts) {
    return ListView(
  ...
  /// of four big sensor cards, then products and alerts side by side filling
  /// the remaining height — so the page is used with no empty bottom.
                    ...
                    children: <Widget>[
                      ...
                      Expanded(
                        child: SingleChildScrollView(
                          child: _LatestProducts(products: products),
                        ),
                      ),
                    ],
                  ),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Expanded(
                        child: SingleChildScrollView(
                          child: _AlertSummary(alerts: alerts),
                        ),
                      ),
                    ],
                  ),
